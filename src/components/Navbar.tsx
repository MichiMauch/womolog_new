          ...
          <div className="flex items-center px-2 lg:px-0">
            ...
            <div className="hidden lg:ml-6 lg:block">
              <div className="flex space-x-4">
                ...
                <a href="stats" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                  Stats
                </a>
                <a href="map" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                  Map
                </a>
